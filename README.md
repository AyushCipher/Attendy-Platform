...
[`attendy-v2/docs/adr/`](attendy-v2/docs/adr/README.md) for the reasoning behind the
harder decisions.
...
- **Recognizes** faces live over WebSocket, with per-track identity assignment via
  the Hungarian algorithm, smoothing across frames (4-of-6 agreement) and gating on
  a motion-based liveness check before ever writing an attendance record.
